...
public class DianMingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // 数据库数据以学号排序放在C中
        final Cursor c = sqRead.query(Student.TABLE,null,null,null,null,null,Student.KEY_SNO);
        ...
        if(c.getBlob(4)!=null) { //存有头像
            ...
            ivTouXiang.setImageResource(R.mipmap.ic_launcher);
        }
        ...
        btnUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //为了实时显示操行情况
                Cursor cCaoXing = sqRead.query(Student.TABLE, new String[]{Student.KEY_SBEIZHU},
                        Student.KEY_SNO + "=?", new String[]{tvSno.getText().toString()}, null, null, null);
                cCaoXing.moveToNext();
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put(Student.KEY_SBEIZHU,etCaoXing.getText().toString()+" "+
                        etCXBeiZhu.getText().toString()); //把数据库中备注更新为当前操行情况框中的值
                sqWrite.update(Student.TABLE,values,Student.KEY_SNO+"=?",
    ...
    public void sqInsert(){
        ...
        for(int i=1;i<=3;i++){
            ...
            values.put(Student.KEY_SNO,"631406010101"+i);
            values.put(Student.KEY_SNAME,"莫天金"+i);
            values.put(Student.KEY_SCLASS,"计科一班"+i);
            values.put(Student.KEY_SBEIZHU,"在勤"+i);
            sql_db.insert(Student.TABLE,null,values);
        }
    }
}
